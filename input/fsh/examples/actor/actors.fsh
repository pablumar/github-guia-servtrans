...
Title: "Actor Laboratory Report Handler"
Description: """Laboratory Report Handler: a generic system dealing with Laboratory Reports"""
Usage: #example

* url = "http://hl7.eu/fhir/laboratory/actor-handler-eu-lab"
* name = "LabReportHandler"
* status = #active
* type = #system
// * type = #entity
* documentation = """This actor represents a generic system dealing with Laboratory Reports."""
